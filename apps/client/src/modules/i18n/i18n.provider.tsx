...
import { translations as defaultTranslations } from '../../locales/en';
...
export const I18nProvider: ParentComponent = props => {
  ...
  const [getLocale, setLocale] = makePersisted(createSignal<Locale>(browserLocale), { name: 'owlrelay_locale', storage: localStorage });
